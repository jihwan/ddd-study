...
public class Registrar {
	...
	public static void delete(Class<?> entryPointClass, String objectName) {
		soleInstance.deleteObj(entryPointClass, objectName);
	}
	
	private void deleteObj(Class<?> entryPointClass, String objectName) {
		entryPoints.get(entryPointClass).remove(objectName);
	}
}